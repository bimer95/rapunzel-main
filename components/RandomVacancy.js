export default function RandomVacancy() {
    return (
        ...
        //                 </div>
        //                 <div className="">    
        //                         <p> Злые марсиане ищут аккаунт-менеджера на полную занятость в распределенную команду (удаленная работа). Напишите нам, если:   Вы хотите работать из любой точки страны или мира: Злые марсиане работают распределенно со дня основания и знают, как выстраивать асинхронные процессы в команде. Вы готовы помогать глобальным проектам и стартапам на стадиях пивота (поиска масштабируемой бизнес-модели) или...</p>
        //                 </div>
        //             </div>
        //         </div>
